...
""" LabelEncoder is a preprocessing tool from the scikit-learn library that converts
  categorical (text) data into numerical labels so that machine learning algorithms 
...
# standard_scaler = StandardScaler()  # This object will standardize features by removing the
